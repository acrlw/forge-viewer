...
help:
	@printf '%s\n' \
		...
		'  make format-compat      scene snapshot and recording compatibility' \
...
stability: rpc-soak format-compat
...
format-compat:
	...
	$(PYTEST) -q -m physics tests/test_scene_state.py -k 'version or legacy or future'
