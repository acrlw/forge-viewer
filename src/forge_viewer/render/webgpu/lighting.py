...
# Slope-scaled bias factors, mirroring forge passes/shadow.py SHADOW_BIAS.
SHADOW_BIAS = (1.0, 2.5)
...
class LightSchedule:
    """Port of ``render.forge.passes.base.LightSchedule``."""
...
@dataclass
class ShadowState:
    """Per-frame shadow caster payload, mirroring forge passes/base.py ShadowResult.
