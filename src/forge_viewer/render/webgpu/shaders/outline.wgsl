...
//
// Direct port of forge's outline pipeline (passes/outline.py + outline.frag +
...
//   the object even where an occluder hides it.  Deliberate delta from forge:
//   the forge mask is 4x MSAA resolved into R8, which carries subpixel
...
const OUTLINE_RADIUS: i32 = 3;  // forge OUTLINE_RADIUS
